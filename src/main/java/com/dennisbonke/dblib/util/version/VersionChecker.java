...
public class VersionChecker {
    ...
    private int mod_major, mod_minor, mod_rev, mod_build;
    private long size;
    ...
    public VersionChecker(String jsonURL, String modid, String modname, int major, int minor, int rev, int build) {
        ...
        this.mod_rev = rev;
        this.mod_build = build;
        this.currentVer = this.mod_major + "." + this.mod_minor + "." + this.mod_rev + "." + this.mod_build;
    ...
    public VersionChecker(String jsonURL, String mod, int major, int minor, int rev, int build) {
        this(jsonURL, mod, mod, major, minor, rev, build);
    }
    ...
    public void checkForUpdates() {
        try {
            ...
            LogHelper.error("Could not check for updates!");
